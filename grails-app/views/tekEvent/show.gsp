...
%{--			<h1><g:message code="default.show.label" args="[entityName]" /></h1>--}%
			...
			<ol class="property-list tekEvent">
				...
				<g:if test="${tekEventInstance?.sponsorship}">
				<li class="fieldcontain">
					<span id="sponsorship-label" class="property-label"><g:message code="tekEvent.sponsorship.label" default="Sponsorship" /></span>

						<g:each in="${tekEventInstance.sponsorship}" var="s">
						<span class="property-value" aria-labelledby="sponsorship-label"><g:link controller="sponsorship" action="show" id="${s.id}">${s?.sponsor.encodeAsHTML()}</g:link></span>
						</g:each>
